...
<head>
    ...
    <!-- Bootstrap CSS -->
    {{-- <link rel="shortcut icon" href="{{ asset('assets/img/computer.jpg') }}"> --}}
...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-custom shadow-sm py-3 fixed-top bg-success">
        <div class="container">
            <a class="navbar-brand text-white" href="{{ url('/') }}"><b>Toko Zulaikha</b></a>
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                @foreach ($kategori as $r)
                                    <li><a class="dropdown-item"
                                            href="{{ url('kategori/' . $r->id) }}">{{ $r->name }}</a></li>
                                @endforeach
                            </ul>
                        </li>
                    </ul>
                    ...
                    <li class="nav-item">
                        @if (isset(auth()->user()->name))
                            <a class="nav-link active bg-warning text-black"
                                href="{{ url('dashboard') }}">Dashboard</a>
                        @else
                            <a class="nav-link active" href="{{ url('login') }}">Login / Register</a>
                        @endif
                    </li>
                </ul>
            </div>
    ...
    <div class="footer">
        <div class="container">
            <div class="row">
                <div class="col-sm-8">
                    <h4>Butuh Bantuan</h4>
                    <p class="pt-2">Jam Kerja : 08:00 - 17:00 WIB / (Senin - Jumat)</p>
                    <p><i class="fas fa-envelope-square me-2"></i>zulaikhafrozenfood98@gmail.com</p>
                    <p><i class="fab fa-whatsapp"></i> +62 838-6296-0325</p>
                    <p><i class="fas fa-map-marker-alt me-2"></i>Sanggrahan, RT 02 / RW 05, Joho, Sukoharjo, Jawa Tengah
                    </p>
                </div>
                <div class="col-sm-4">
                    ...
                    <form method="get" action="{{ url('search') }}">
                        <div class="modal-body">
                            <div class="form-group">
                                <input type="text" name="keywords" autocomplete="off" class="form-control" placeholder="Search disini !">
                            </div>
                        </div>
